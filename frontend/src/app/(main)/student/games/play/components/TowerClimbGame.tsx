...
export default function TowerClimbGame({
  ...
  return (
    <div className="space-y-8 py-4 z-10 flex flex-col justify-between h-full flex-1 relative">
      {/* Question Presentation */}
      <div key={`presentation-${questionIndex}`} className="text-center space-y-3 py-6 animate-slide-in">
        <p className="text-xs font-black uppercase text-sol-accent tracking-widest">
          {t("towerClimbFloor", { n: questionIndex + 1 })}
        </p>
