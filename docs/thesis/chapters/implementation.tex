...
\section{Question Generation and Grading}

The file \code{backend/services/mathService.ts} contains a central part of the project: logic-driven variable generation and answer evaluation. The implementation supports several rule types:
\begin{itemize}
...
\section{Administrative Implementation}
