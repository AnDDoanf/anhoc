...
\bibitem{sympy-paper}
A. Meurer, C. P. Smith, M. Paprocki, et al. \textit{SymPy: symbolic computing in Python}. PeerJ Computer Science, 3:e103, January 2017. Available at: \url{https://doi.org/10.7717/peerj-cs.103}.

\bibitem{fastapi-docs}
Sebastián Ramírez. \textit{FastAPI Documentation}. Available at: \url{https://fastapi.tiangolo.com/}. Accessed June 15, 2026.

\bibitem{bullmq-docs}
Taskforce.sh. \textit{BullMQ: Message Queue and Batch Processing for NodeJS}. Available at: \url{https://bullmq.io/}. Accessed June 15, 2026.

\bibitem{gemini-api}
Google. \textit{Gemini API Overview}. Available at: \url{https://ai.google.dev/gemini-api/docs}. Accessed June 22, 2026.

\bibitem{tailwindcss-v4}
Tailwind Labs Inc. \textit{Tailwind CSS v4.0 Documentation}. Available at: \url{https://tailwindcss.com/docs}. Accessed June 22, 2026.
\end{thebibliography}
